...
class CleanGPTModels:
    ...
    def create_corrected_dom_column(self, path):
        ...
        self.df['DOMCorrected'] = dom_corrected
    ...
    def call_corrections2violations(self, url):
        ...
        dom_corrected = self.df.iloc[0]['DOMCorrected']
        print("checking", url)
...
def main():
    ...
    create_test_script(url)  # find violations
    ...
    result = model.call_corrections2violations(url)
